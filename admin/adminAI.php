      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            >
              Approached / Contacted Internees
            </h2>
            <!-- CTA -->
            <a
                  ...
                  <table class="w-full whitespace-no-wrap" id="dataTable">
                    <thead>
                      ...
                      >
                        ...
                        <th class="px-4 py-3">PEC #</th>
                        <th class="px-4 py-3">DICIPLINE</th>
                        <th class="px-4 py-3">PREFERED CITY</th>
                        <th class="px-4 py-3">GRADUATION YEAR</th>
                        <th class="px-4 py-3">SUBMITED TIME</th> 
