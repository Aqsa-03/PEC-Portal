...
$sql = "SELECT id, fullName, ntnNumber, cnicNo, emailAddress, phoneNo, dateofBirth, graduationYear, education, discipline, industry, preferredCity, registrationTimestamp, address FROM completedInternees";
            ...
            <!-- <template x-if="isPagesMenuOpen">
              <ul x-transition:enter="transition-all ease-in-out duration-300"
                ...
                <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                  <a class="w-full" href="adminECD.html">Engineer Contact Details</a>
                </li>
                <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                  <a class="w-full" href="adminCCD.html">
