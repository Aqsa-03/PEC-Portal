...
$sql = "SELECT cName, cNtnNumber, internees, discipline FROM notes";
  ...
  <body>
    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a
            class="flex flex-wrap h-full items-center ml-6 text-lg font-bold text-gray-800 dark:text-gray-200"
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              ></span>
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 text-gray-800 dark:hover:text-gray-200"
                href="adminJL.php"
              >
                <svg
                  class="w-5 h-5"
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              <div
                class="relative w-full max-w-xl mr-6 focus-within:text-purple-600"
              >
    ...
    <thead>
        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
            ...
            <th class="px-4 py-3">NTN Number</th>
            <th class="px-4 py-3">Internees Required</th>
    ...
    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td class='px-4 py-3 text-sm'>" . $row['cNtnNumber'] . "</td>";
            echo "<td class='px-4 py-3 text-xs'><span class='px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100'>" . $row['internees'] . "</span></td>";
