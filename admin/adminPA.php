                ...
                <div class="w-full overflow-x-auto">
                  <table class="w-full whitespace-no-wrap" id="dataTable">
                    <thead>
                      ...
                      >
                        <th class="px-4 py-3">Employer ID</th>
                        <th class="px-4 py-3">Employer NAME</th>
                        <th class="px-4 py-3">Engineer Name</th>
                        <th class="px-4 py-3">Engineer ID</th>
                        <th class="px-4 py-3">Contact #</th>
                        <th class="px-4 py-3">Month</th>
                        <th class="px-4 py-3">Past Performance</th>
                        <th class="px-4 py-3">Major Observation</th> 
