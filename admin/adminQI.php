...
$sql = "SELECT id, fullName, ntnNumber, cnicNo, emailAddress, phoneNo, dateofBirth, graduationYear, education, discipline, industry, preferredCity, registrationTimestamp, address FROM quitterinternees";
