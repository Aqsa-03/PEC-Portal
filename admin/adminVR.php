    ...
    >
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Report Genration</span>
              </a>
            </li>
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            $sql = "SELECT ntnNumber, fullName, uploadResume FROM internees";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="px-4 py-3 text-sm">' . $row["ntnNumber"] . '</td>';
                    echo '<td class="px-4 py-3 text-sm">' . $row["fullName"] . '</td>';
                    echo '<td class="px-4 py-3 text-sm"><a href="#" onclick="openFileInNewTab(\'' . $row["uploadResume"] . '\')">View Resume</a></td>';
                    echo '</tr>';
                }
            } else {
