...
<head>
        ...
        <title>PEC INTERN PROGRESS PORTAL </title>
        <style>
                .carousel {
                        opacity: 0.9;
                }
                ...
                <div class="row">
                        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
                                <a href="" class="navbar-brand">
                                        <img src="images\logo.png" alt="" width="110px" height="90px" />
                                </a>
                                <button class="navbar-toggler mx-2 bg-light" data-bs-toggle="collapse"
                                ...
                                <div class="collapse navbar-collapse" id="mynavbar">
                                        <ul class="navbar-nav">
                                                <li class="nav-item">
                                                        <a class="nav-link text-white fs-4 px-sm-2" href="#">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                        <a class="nav-link text-white fs-4 px-sm-2"
                                                                href="internee\login.php">Internee</a>
                                                </li>
                                                <li class="nav-item">
                                                        <a class="nav-link text-white fs-4 px-sm-2"
                        ...
                        <div class="carousel slide" id="mycarousel" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                        <div class="carousel-item active">
                                                <img src="images\1.jpg" class="d-block w-100" alt="" height="800px" />
                                                <div class="carousel-caption">
                                                        <h3 class="text">Welcome To</h3>
                                                        <h1 class="text1">PEC INTERNEE PORTAL</h1>
                                                </div>
                                        </div>
                                        <div class="carousel-item">
                                                <img src="images\2.jpg" class="d-block w-100" alt="" height="800px" />
                                                <div class="carousel-caption">
                                                        <h3 class="text">Welcome To</h3>
                                                        <h1 class="text1">PEC INTERNEE PORTAL</h1>
                                                </div>
                                        ...
                                        <div class="carousel-item">
                                                <img src="images\3.jpg" class="d-block w-100" alt="" height="800px" />
                                                <div class="carousel-caption">
                                                        <h3 class="text">Welcome To</h3>
                                                        <h1 class="text1">PEC INTERNEE PORTAL</h1>
                                                </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                                                <div class="widget subscribe no-box">
                                                                        <h5 class="widget-title">Pakistan Engineering
                                                                                Council<span></span></h5>
                                                                        <p>This company gives Internship to the fresh
                                                                                Graduate Engineers and set them in
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                                                <div class="widget no-box">
                                                                        <h5 class="widget-title">Get
                                                                                Started<span></span></h5>
                                                                        <p>Get access to PEC main Website</p>
                                                                        <a class="btn" href="https://www.pec.org.pk/"
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                                                ...
                                                                <div class="widget no-box">
                                                                        ...
                                                                        <p><a href="mailto:info@domain.com"
                                                                                        title="glorythemes">pec@info.org.pk</a>
                                                                        </p>

                                                                        <p>03209120917</p>
                                                                        <ul class="social-footer2">
                                                                                <li class=""><a title="youtube"
                                                                                                target="_blank"
                                                                                                href="https://bit.ly/3m9avif"><img
                                                                                                        alt="youtube"
                                                                                                        width="30"
                                                                                                        height="30"
                                                                                ...
                                                                                <li class=""><a href="https://twitter.com"
                                                                                                target="_blank"
                                                                                                title="Twitter"><img
                                                                                                        alt="Twitter"
                                                                                                        width="30"
                                        ...
                                        <div class="container">
                                                <div class="row">
                                                        <div class="col-md-12 text-center">
                                                                <p>Copyright pec © 2023. All rights reserved.</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
